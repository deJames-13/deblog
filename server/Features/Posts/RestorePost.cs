...
public static class RestorePostEndpoint
{
    public static RouteGroupBuilder MapRestorePost(this RouteGroupBuilder group)
    {
            ...
            CancellationToken ct) =>
        {
            ...
            if (post == null)
            {
                return Results.NotFound(new { message = "Post not found in trash" });
            }
        ...
        .WithSummary("Restore a soft-deleted post from trash (Admin Only)");
